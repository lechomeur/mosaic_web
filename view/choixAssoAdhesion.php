...
<section class="home-section">
    <div class="home-content">
        <h2>Quelle association voulez-vous consulter pour les adhésions ?</h2> <!-- Titre ajouté -->
        <div class="sections">
            <?php foreach ($associations as $association): ?>
                <div class="section">
                    ...
                    <a href="?controller=adhesion&action=getAllAdhesion&association_id=<?= $association->getId() ?>" class="btn">Consulter les adhésions</a>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
